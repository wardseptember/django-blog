# -*- coding: utf-8 -*-
# Generated by Django 1.11.12 on 2019-08-22 10:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True)),
                ('description', models.TextField(default='wardseptember,个人博客,python,机器学习,深度学习', help_text='用来作为SEO中description,长度参考SEO标准', max_length=240, verbose_name='描述')),
            ],
            options={
                'verbose_name': '分类',
